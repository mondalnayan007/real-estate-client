...
export default function OurVision() {
  ...
  return (
    <section className="w-full bg-[#185F35] text-white py-16 transition-colors duration-300">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          {/* Main Title */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-wider uppercase leading-tight text-white">
            YOUR DREAM HOME AWAITS
          </h1>

          {/* Subtitle / Description */}
          <p className="text-sm sm:text-base text-slate-300 font-normal leading-relaxed max-w-3xl mx-auto">
