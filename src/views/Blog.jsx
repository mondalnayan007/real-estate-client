...
export default function Blog() {
  ...
  // 🚀 Fetch Blogs Data from API (With Fallback Strategy)
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        setLoading(true);

        // agentId থাকলে সেটি প্যারামে পাঠাবে, না থাকলে শুধু `/api/blogs` হিট করবে
        ...
        // 🎯 লজিক: API থেকে ডাটা পেয়ে যদি ১টি বা তার বেশি ব্লগ থাকে তবে সেটি দেখাবে, 
        // আর যদি ফাঁকা Array ([]) আসে তবে ডিফল্ট/ডেমো ডাটা সেট হবে।
        ...
        // API অফলাইন বা ত্রুটি থাকলেও ডিফল্ট ডাটা দেখাবে
        setBlogs(demoBlogs);
      } finally {
        setLoading(false);
      }
...
// 📌 Default Demo Data (Exported so details page can also fallback to this)
export const demoBlogs = [
  {
    ...
    content: 'Full article content for Top Real Estate Company in Bangladesh goes here...',
  ...
  },
  {
    ...
    content: 'Full article content for Best Real Estate Company in Bangladesh goes here...',
    category: 'Investment',
    date: '2025-10-19',
    readTime: '5 min read',
    author: 'Admin',
  ...
  },
  {
    ...
    content: 'Full article content for Property Developer in Dhaka goes here...',
  ...
  },
  {
    ...
    content: 'Full article content for Flat for Sale in Dhaka goes here...',
  ...
  },
  {
    ...
    content: 'Full article content for Trusted Real Estate Company goes here...',
    category: 'Investment',
    date: '2025-10-19',
    readTime: '5 min read',
    author: 'Admin',
  ...
  },
  {
    ...
    content: 'Full article content for Luxury Apartments goes here...',
    category: 'Architecture',
    date: '2025-10-19',
    readTime: '5 min read',
    author: 'Admin',
